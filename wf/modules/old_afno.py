...
class AFNO2D(nn.Module):
    def __init__(self, dim, num_blocks=8, sparsity_threshold=0.01, hard_thresholding_fraction=1, hidden_size_factor=1):
        super().__init__()
    ...
    def forward(self, x: torch.Tensor, field_size: tuple[int, int]) -> torch.Tensor:
        B, N, C = x.shape
        H, W = field_size
